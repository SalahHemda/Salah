...
async def play(_, message: Message):
            ...
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await USER.send_message(
                        message.chat.id, "** بخ انا جيت اعملي كوباية شاي بق 😿😂  ...**")

                except UserAlreadyParticipant:
                    pass
                except Exception:
                    await lel.edit(
                        f"**الحساب المساعد محظور او مقيد من الجروب  @{ASSISTANT_USERNAME} اتواصل مع مطوري لحل المشكلة @{OWNER_USERNAME} 💎 **")
    try:
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/6fdef02fc5f2500599f86.jpg"
    ...
    if int(chat_id) in ACTV_CALLS:
        ...
        await message.reply_photo(
            photo="final.png",
            caption="** هشغلهالك بعد الاغنيه اللي شغاله دي اصبر ...**".format(position),
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption="**شغلتهالك اهو اي خدمه ...**".format(),
           )
...
async def resume(_, message: Message):
    ...
    await message.reply_text("**⏸ تم استمرار التشغيل ...**"
    )
...
async def stop(_, message: Message):
    ...
    await message.reply_text("**مفيش حاجه شغاله ️...**"
    )
...
async def update_admin(client, message):
    ...
    await message.reply_text("**قيد التحديث️...**")